...
@Entity
@Table(name = "users", schema = "mydatabasedao")
public class UsersEntity {
    ...
    public boolean equals(Object o) {
        ...
        if (typeOfBeer != null ? !typeOfBeer.equals(that.typeOfBeer) : that.typeOfBeer != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (typeOfBeer != null ? typeOfBeer.hashCode() : 0);
